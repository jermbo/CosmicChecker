...
.box3 {
  ...
  tasks: [
    ...
    },
    {
      ...
      instructions: "Give '.box3' a 'border-radius' of 50px",
      hint: "border-radius: 50px;",
    },
    {
      type: "externalStyles",
      el: ".box3",
...
.button2:hover {
  ...
  tasks: [
    ...
    },
    {
      ...
      instructions: "Give '.button2:hover' a 'color' of #ffbfce",
      hint: "color: #ffbfce;",
    },
    {
      type: "externalStyles",
      ...
      instructions: "Give '.button2:hover' a 'background' of #501723",
