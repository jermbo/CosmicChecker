...
const looper = {
  desc: "In this portion we are going to create all the markup we are going to need to build a individual movie. You are going to need a few things; div, h2, img, class, src, and text",
...
const wonderWoman = {
  desc: "Wonder Woman is going to contain a lot of the same markup you created last time. Can you spot the differences?",
...
const bladRunner = {
  desc: "Blade Runner is going to contain a lot of the same markup you created last time. Can you spot the differences?",
...
const starWars = {
  desc: "Star Wars is going to contain a lot of the same markup you created last time. Are you starting to see a pattern?",
